  ...
  div.container-fluid
    ...
    div.row
      div.col-xs-6.col-sm-3
        label
          | Perk Level 
          input#perkLVL.equipCatValidation(type='number' v-on:click.prevent='validate' v-on:change.prevent='validate' v-on:keydown='validate' v-on:keyup='validate' v-model='perkLevel' name='perklevel' min='1' max='25' value='1')
    div.row
    ...
    div.row  
      div.col-xs-6.col-sm-3.col-md-2.col-lg-2
        label
          input#deadeye(type='checkbox' tooltip='Perk Level Must Be At Least 20' :disabled='rackemBool' v-model='Deadeye' value='')
          | Deadeye
    div.row  
      div.col-xs-6.col-sm-4.col-md-2.col-lg-2
        label
          input#rackemchk(type='checkbox' tooltip='Perk Level Must Be At Least 15' :disabled='deadeyeBool' v-model='Rackem' value='')
          | Rack em Up
