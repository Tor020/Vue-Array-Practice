  ...
  div.container-fluid
    ...
    div.row
      div.col-xs-6.col-sm-3.col-lg-2
        label
          | Perk Level 
          input#perkLVL.equipCatValidation(type='number' v-on:click.prevent="validate(); perkCheck()" v-on:change.prevent="validate(); perkCheck()" v-on:keydown="validate(); perkCheck()" v-on:keyup="validate(); perkCheck()" v-model="perkLevel" name='perklevel' min='1' max='25' value='1')
    div.row
      div.col-xs-6.col-sm-5.col-md-5.col-lg-5
        label
          input#bringTH(type='checkbox' v-model='bringTheHeat' tooltip='Perk Level Must Be At Least 5' value='')
          | Bring The Heat
