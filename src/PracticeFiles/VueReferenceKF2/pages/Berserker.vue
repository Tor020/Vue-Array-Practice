  ...
  div.container-fluid
    ...
    div.row
      div.col-xs-6.col-sm-4.col-md-3.col-lg-2
        label
          input#chkbutch(type='checkbox' tooltip='Perk Level Must Be At Least 10' v-model='butcher' value='')
          | Butcher
      div.col-xs-6.col-sm-4.col-md-3.col-lg-3
          select(multiple class="form-control" tooltip='Perk Level Must Be At Least 20' v-model="selection" :disabled="perklvlbool")
